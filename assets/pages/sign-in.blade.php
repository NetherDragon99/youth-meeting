    ...
    <div id="profilePagePages">
      <form id="userProfileForm">
        <legend id="userFormMainData" data-name="loginHeader">
          ...
          <label for="userFormUsername" data-name="emailPhone">
            <div class="icon-pencil"></div>
            <p>الايميل/رقم التليفون</p>
            <input type="text" id="userFormEmailPhone" name="emailPhone" placeholder="اكتب اسمك الى هيكون ظاهر للكل" required>
          </label>
          <label for="userFormUsername" data-name="password">
            <div class="icon-lock"></div>
            <p>كلمة المرور</p>
            <input type="password" id="userFormPass" name="password" placeholder="اكتب اسمك الى هيكون ظاهر للكل" required>
          </label>
          <p id="noAccount" onclick="changeLocationToSignUp()">ليس لديك حساب؟؟</p>
        </legend>
        <button id="userFormSubmitBtn" onclick="getFormDataBtn(event, 'signIn')">
      ...
      <div id="appSettings">
        ...
        <label for="appTheme" data-name="appTheme">
          <div class="icon-sun"></div>
          <p>المظهر</p>
          <select name="theme" id="appTheme">
            <option value="light">النهارى</option>
