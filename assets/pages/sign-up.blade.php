      ...
      <form id="userProfileForm">
        <legend id="userFormMainData">
          ...
          <label for="userFormGender" data-name="gender">
            ...
            <p>النوع</p>
            <select id="userFormGender" name="gender">
              <option value="unselected" selected disabled>اختار النوع</option>
          ...
          <label for="userFormPassword" data-name="password">
            ...
            <p>كلمة المرور</p>
            <input type="password" id="userFormPass" name="password" placeholder="كلمة المرور">
          </label>
          <p id="backToSignIn" onclick="changeLocationToSignIn()">اللرجوع لتسجيل الدخول</p>
        </legend>
